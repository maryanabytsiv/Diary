...
public class DBCreationManager {
	...
	public static void setUpBeforeClass() throws SQLException {
		...
		try (BufferedReader br = new BufferedReader(new FileReader("./PostgreSQL_DB/DiaryTest.sql"))) {
	...
	public static void DropTableIfExists() throws SQLException {
		String dropTable="DROP TABLE IF EXISTS tag_record;" + "DROP TABLE IF EXISTS record_list;"
