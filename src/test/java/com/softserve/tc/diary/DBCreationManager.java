...
public class DBCreationManager {
    ...
    public static void insertValue() throws SQLException {
        String insertData = 
                ...
                + "insert into record_list values('1',null,'2015-02-23 00:00:00', 'bob' ,'#Hello my name is Bob. I am from #NewYork', "
                + "'https://motivation/inUkraine/improveMySelf','PUBLIC');"
                + "insert into record_list values('2',null,'2015-05-20 12:00:56', 'Halloween', 'That was #nice day. #Halloween so cool', "
                + "'http:/bigBoss/works/perfectly','PRIVATE');"
                + "insert into record_list values('3',null,'2015-06-10 17:20:56', 'Team', '#HelloTeam, it is #nice to meet in NewYork', "
