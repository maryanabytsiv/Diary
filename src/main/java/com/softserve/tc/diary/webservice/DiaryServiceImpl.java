...
public class DiaryServiceImpl implements DiaryService {
	...
	public String logIn(String nickName, String password) {
		...
		if (user == null) {
			...
			String encryptedPassword = password != null ? PasswordHelper.encrypt(password) : null;
	...
	public boolean addRecord(String nickname, Status status, String record) {
		...
		if (user == null) {
			...
			Record newRecord = new Record(user.getUuid(), createdTime, null, record, null, status);
